...
\section{Mã nguồn và Video mô phỏng}
Dưới đây là đường dẫn đến mã nguồn toàn bộ bài tập lớn và video mô phỏng hoạt động của hệ thống:

\begin{itemize}
    \item \textbf{Project Source Code (GitHub):} \\
    \url{https://github.com/phunguyenhoangminh-gif/os_assignment_nhom1/tree/main/ossim_lamiaatrium} % link GitHub
    
    \item \textbf{Demo Video (YouTube):} \\
    \url{https://drive.google.com/file/d/1vLkeMl3E0PBn65lm1gdIrDpL5oF7TzEh/view?usp=sharing} % link video (YouTube)
\end{itemize}